--SQL Server üzerinde ki User'ların script'ini oluşturur.
--Bu procedure oluşturulduktan sonra "EXEC sp_help_revlogin" çalıştırılır. Messages alanında oluşturulan ilgili userların create scriptleri yeni sunucuda çalıştırılabilir.
USE [master]
  GO
